...
- Markdown normalization for headings, lists, paragraphs, links, and common inline formatting
...
- Setup wizard support and `ktx connection test` support are deferred to follow-up work
